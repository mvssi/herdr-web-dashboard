...
const DOM = {
    ...
    btnKeyboardToggle: document.getElementById('btn-kbd-mode'),
    // Confirm Banner
    ...
    fsBrowserCrumbs: document.getElementById('fs-browser-crumbs'),
    fsBrowserShortcuts: document.getElementById('fs-browser-shortcuts'),
    fsBrowserList: document.getElementById('fs-browser-list'),
    fsBrowserNewFolder: document.getElementById('fs-browser-newfolder'),
    inputFsNewFolderName: document.getElementById('input-fs-newfolder-name'),
    btnFsNewFolder: document.getElementById('btn-fs-new-folder'),
    btnFsNewFolderOk: document.getElementById('btn-fs-newfolder-ok'),
    btnFsNewFolderCancel: document.getElementById('btn-fs-newfolder-cancel'),
    // Rename Agent Dialog
    ...
    // Rename / Delete Workspace Dialogs & New Tab Dialog
    dialogRenameWs: document.getElementById('dialog-rename-ws'),
    renameWsOrigName: document.getElementById('rename-ws-orig-name'),
    renameWsSubtitle: document.getElementById('rename-ws-subtitle'),
    inputRenameWsName: document.getElementById('input-rename-ws-name'),
    btnRenameWsConfirm: document.getElementById('btn-rename-ws-confirm'),
    btnRenameWsCancel: document.getElementById('btn-rename-ws-cancel'),
    btnRenameWsX: document.getElementById('btn-rename-ws-x'),
    dialogDeleteWs: document.getElementById('dialog-delete-ws'),
    deleteWsText: document.getElementById('delete-ws-text'),
    btnDeleteWsConfirm: document.getElementById('btn-delete-ws-confirm'),
    btnDeleteWsCancel: document.getElementById('btn-delete-ws-cancel'),
    dialogNewTab: document.getElementById('dialog-new-tab'),
    newTabWsName: document.getElementById('new-tab-ws-name'),
    inputNewTabLabel: document.getElementById('input-new-tab-label'),
    btnNewTabConfirm: document.getElementById('btn-new-tab-confirm'),
    btnNewTabCancel: document.getElementById('btn-new-tab-cancel'),
